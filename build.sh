...
cmake -B "$BUILD_DIR" -S . -DCMAKE_BUILD_TYPE=Release -DENABLE_WASAPI=ON -DENABLE_BINARY=ON -DENABLE_PYTHON=ON -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DENABLE_NODE_JS=OFF
